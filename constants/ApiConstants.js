...
const statusMessages= {
    ...
    segmentGetFailedNotFound: "Segment Details doesn't exist for the given criteria.",
    ...
    categoryGetFailedNotFound: "Category Details doesn't exist for the given criteria.",
